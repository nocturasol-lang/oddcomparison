...
from core.market_allowlist import is_market_allowed as check_market_allowed
...
class BaseScraper(ABC):
    ...
    @staticmethod
    def is_market_allowed(market_std: str, sport: str = "soccer") -> bool:
        """Return True only if market_std is in the allowlist for the given sport."""
        return check_market_allowed(sport, market_std)
